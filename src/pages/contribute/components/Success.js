  ...
  return (
    <div>
      ...
      <div className='is-flex-direction-column is-justify-items-center'>
        ...
        <h1 className='is-size-5 has-text-centered pt-2'>
        ...
        <p className='has-text-centered pt-2'>
          Will be transferred to your Ethereum address soon.
        </p>
        <div className='button-container pt-6'>
          <TwitterShareButton
            url='https://commonsstack.org'
            title='I funded the Commons Stack!'
          >
          ...
          >
            <button className='button is-info'>
              <TelegramIcon size={32} round className='mr-2' /> Share on
              Telegram
            </button>
          </TelegramShareButton>
        </div>
